...
layui.use('layer', function() {
	...
	window.popnotice = function popnotice() {
		layer.open({
			...
			content: '<div style="padding: 30px; line-height: 24px; background-color: #393D49; color: #fff; font-weight: 300; font-size: 16px;"><p><font color="yellow">新增支持邮箱账号</font></p><p>建议微信步数不要过多，否则被举报会封微信运动排行榜7天，7天后自动解封</p>被封排行榜不会影响微信的使用，仅仅是微信运动7天都是0步</p>',
