...
$统计='';//统计代码
$资源接口='https://www.zkzy.tv/inc/zkm3u8.php'; //资源站接口，若替换，下面分类也要替换
$资源分类='<ty id="21">韩国三级</ty><ty id="39">日本三级</ty><ty id="38">香港三级</ty><ty id="41">福利短视频</ty>';
$资源替换=array('<script>'=>'');

$展示时效='';//展示 &h=24 &h=48 &h=168 或者留空
$倒序='yes';//也可以是no，一般资源站资源是倒排的，建议填yes
$解析='https://jx.zkzy3.com/?url='; //仿B站解析
$数据缓存='1';//单位小时
$模板='default';
$标题['list']="yk[网站名]";
