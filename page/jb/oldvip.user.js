...
// @name              X全网视频会员
// @version           1.9.4.2
// @description       本脚本集合了哔哩哔哩番剧解锁,B站视频下载、解析，A站视频下载、解析，优酷、爱奇艺、腾讯、芒果、乐视、等全网视频平台免费去广告观看VIP会员视频以及高清普清电视观看，增加对手机支持(手机端现仅支持弹窗播放)，现已添加网易云等平台音乐免费下载，抖音短视频去水印。若播放页不显示此插件或播放失败，请反馈QQ2943871928.
// @author            程鹏
// @icon              https://s3.ax1x.com/2020/12/09/rCrT7d.jpg
...
// @downloadURL       http://app.5luck.cn/jb/vip.js
...
(function () {
    ...
    var originalInterfaceList = [
        ...
        { name:"线路二", type:"1", url:"https://jiexi.q-q.wang/?url="},
        { name:"线路三", type:"1", url:"https://api.lhh.la/vip/?url="},
        { name:"线路四", type:"1", url:"https://jiexi.380k.com/?url="},
        { name:"线路五", type:"1", url:"https://jx.youyitv.com/?url="},
        { name:"线路六", type:"1", url:"https://api.tv920.com/vip/?url="},
        { name:"线路七", type:"1", url:"https://jx.618g.com/?url="},
        { name:"线路八", type:"1", url:"https://jx.ivito.cn/?url="},
        { name:"线路九", type:"1", url:"https://api.lhh.la/vip/?url="},
        ...
        { name:"线路二十", type:"1", url:"https://api.bingdou.net/?url="},
        //--------------------------------------------------------------------------------------
        { name:"B站解析一", type:"2", url:"https://jiexi.380k.com/?url="},
        { name:"B站解析二", type:"2", url:"https://jsap.attakids.com/?url="},
        { name:"B站解析三", type:"2", url:"https://api.tv920.com/jx/?url="},
        { name:"B站解析四", type:"2", url:"https://www.h8jx.com/jiexi.php?url="},
        { name:"B站解析五", type:"2", url:"https://api.bingdou.net/?url="},
        { name:"B站解析六", type:"2", url:"https://jiexi.q-q.wang/?url="},
...
<div class='item_text'>
<img src='https://s3.ax1x.com/2020/12/12/rERK2D.png' title='视频解析'/>
<div class='vip_mod_box_action' style='border:5px solid #ffe474;'>
<div style='display:flex;'>
<div style='width:320px; padding:30px 0;'>

<div style='font-size:20px; text-align:center; color:#ebc834; line-height:21px;'><a style=' color:#ffe474;' href="http://app.5luck.cn/www" target="_blank">【访问官网】</a></div>
...
<div style='font-size:10px; text-align:center; color:000; line-height:21px;'><a style='Text-decoration:none; color:#ffe474;' onclick="window.open('http://app.5luck.cn/m')">全网音乐下载</a></div>
<ul style='margin:0 10px;'>
<div style='clear:both;'></div>
</ul>
...
<div style='font-size:10px; text-align:center; color:000; line-height:21px;'><a style='Text-decoration:none; color:#ffe474;' href="http://wpa.qq.com/msgrd?v=3&uin=2943871928&site=qq&menu=yes">CopyRight &copy CP 2020 </a><a style='Text-decoration:none; color:#ffe474;' href="http://app.5luck.cn/jb/vip.js">V_1.9.4.2</a></div>
<ul style='margin:0 10px;'>
<div style='clear:both;'></div>
</ul>
...
<img src='https://s3.ax1x.com/2020/12/12/rE2wH1.png' title='高清电视'/>
...
function openwin()
{window.open("http://bbb.gm88888888.com/o_1erdvb619bs09gk6a91l7ag8fa.mp4","", "height=2000, width=4000,location=no,status=no")
}
function openwin2()
{window.open("https://jx.yingxiangbao.cn/vip.php?url=https://cdn.czdxhb.com/20200507/lMby4OVH/index.m3u8","","width=1500,height=2000")
}
function openwin3()
...
<li><a href="#" onclick="openwin()">测试视频</a></li>
...
<li><a href="#" onclick="openwin5()">鞠婧祎</a></li>
<li><a href="#" onclick="openwin2()">刘亦菲</a></li>
<li><a href="#" onclick="openwin3()">杨幂</a></li>
<li><a href="#" onclick="openwin4()">杨幂</a></li>
<li><a href="#" onclick="openwin6()">三上悠亚</a></li>
<li><a href="#" onclick="openwin7()">深田咏美</a></li>
</div>
</div>
</div>
</div>
